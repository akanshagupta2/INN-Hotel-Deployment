...
def main():
    ...
    wkday_lambda = (lambda x:0 if x=='Mon' else 1 if x=='Tue' else 2 if x=='Wed' else 3 if x=='Thur' else 4 if x=='Fri' else 5 if x=='Sat'
                     else 6)
    wkday = st.selectbox('What is the weekday of arrival',['Mon','Tue','Wed','Thur','Fri','Sat','Sat'])
